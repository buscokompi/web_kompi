    ...
    <div class="containerall">
        ...
        <div class="container-login">
            ...
            <form class="card-login">
                ...
                <div>
                    <input v-model="password" name="password" class="input-password input-email"
                        placeholder="Buscokompi6." id="password" type="password" required="required"
                        pattern="(?=^.{8,}$)(?=.*\d)(?=.*\W+)(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$" />
                ...
                <div>
                    <input v-model="passwordCheck" name="password2" class="input-password input-email"
                        placeholder="Buscokompi6." id="password2" type="password" required="required"
                        pattern="(?=^.{8,}$)(?=.*\d)(?=.*\W+)(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$" />
                    <input type="checkbox" id="toggle-password2" @click.prevent="seePassword()" />
            ...
            <p class="register">¿Ya tienes una cuenta? <a class="link-signin" href="./login.html">Inicia sesión</a></p>
